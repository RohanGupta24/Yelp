...
1. Implement a page that queries based on price, location, food categories, etc.
2.
...
<img src='https://github.com/RohanGupta24/Yelp/blob/master/YelpGif.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
